...
export default function AboutPage() {
  return (
    <>
      <PageHeader tag="About Me" title="Jonathan Geli — Your Mobile Notary" subtitle="I built Reliable Travel Notary on a simple belief: notary services should be convenient, professional, and personal." />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 56, alignItems: "start" }}>
            <div>
              ...
              <p style={{ color: "var(--slate)", lineHeight: 1.85, fontSize: "0.95rem", marginBottom: 20 }}>
                My name is Jonathan Geli, and I'm a California-commissioned Notary Public and NNA Certified Signing Agent based in the Los Angeles area. Over the past decade, I've had the privilege of helping thousands of individuals, families, and businesses with their notarization needs.
              </p>
              <p style={{ color: "var(--slate)", lineHeight: 1.85, fontSize: "0.95rem", marginBottom: 20 }}>
              ...
              <p style={{ color: "var(--slate)", lineHeight: 1.85, fontSize: "0.95rem", marginBottom: 40 }}>
                When you work with me, you're working directly with me — not a call center or third-party dispatcher. I'm personally responsible for every appointment and every document.
              </p>
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.3rem", color: "var(--navy)", marginBottom: 16 }}>Credentials &amp; Certifications</h3>
              {["California Commissioned Notary Public", "NNA Certified Signing Agent", "Bonded & E&O Insured", "Background Screened", "Serving LA County 10+ Years"].map(c => (
            ...
            <div>
              <div style={{ background: "var(--navy)", borderRadius: 4, padding: "36px 28px", textAlign: "center" }}>
                ...
                <h4 style={{ fontFamily: "'Playfair Display', serif", color: "#fff", fontSize: "1.4rem", marginBottom: 4 }}>Jonathan Geli</h4>
                ...
                <div style={{ borderTop: "1px solid rgba(201,168,76,0.2)", paddingTop: 20, display: "flex", flexDirection: "column", gap: 12 }}>
                  <a href="tel:8187263039" style={{ color: "var(--gold)", fontWeight: 700, fontSize: "1.1rem", textDecoration: "none" }}>📞 818-726-3039</a>
                  <a href="mailto:jgeli@reliabletravelnotary.com" style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.8rem", textDecoration: "none", wordBreak: "break-all" }}>jgeli@reliabletravelnotary.com</a>
                </div>
              </div>
              <div style={{ background: "var(--cream)", borderRadius: 4, padding: "24px", border: "1px solid rgba(201,168,76,0.2)", marginTop: 20 }}>
                ...
                <p style={{ color: "var(--slate)", fontSize: "0.875rem", lineHeight: 1.7, marginBottom: 16 }}>
                  Monday – Sunday<br />
                  Available 7 days a week<br />
                  Including evenings &amp; weekends<br />
