...
export default function BookPage() {
  return (
    <>
      <PageHeader tag="Schedule Now" title="Book an Appointment" subtitle="Use the form below to request your mobile notary appointment with Jonathan Geli. I'll confirm availability and pricing promptly." />
            ...
            <div style={{ background: "#fff", border: "1px solid rgba(10,22,40,0.08)", borderRadius: 4, padding: "40px 36px" }}>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <select style={{ width: "100%", padding: "12px 16px", border: "1px solid rgba(10,22,40,0.15)", borderRadius: 2, fontSize: "0.9rem", fontFamily: "'DM Sans', sans-serif", outline: "none", background: "#fff" }}>
                  ...
                  <option>Hospital / Care Facility Visit</option>
                  <option>Other</option>
                </select>
              </div>
              ...
              <p style={{ color: "var(--slate)", fontSize: "0.8rem", marginTop: 12, textAlign: "center" }}>Jonathan will respond within a few hours to confirm.</p>
            </div>
            <div>
              <div style={{ background: "var(--navy)", borderRadius: 4, padding: "28px 24px", marginBottom: 20 }}>
                <h4 style={{ fontFamily: "'Playfair Display', serif", color: "var(--gold)", marginBottom: 8 }}>Prefer to Call or Text?</h4>
                <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.875rem", lineHeight: 1.7, marginBottom: 16 }}>For urgent or same-day requests, calling or texting is the fastest option. Jonathan answers 7 days a week.</p>
                <a href="tel:8187263039" style={{ color: "#fff", fontWeight: 700, fontSize: "1.2rem", textDecoration: "none", display: "block", marginBottom: 10 }}>📞 818-726-3039</a>
                <a href="mailto:jgeli@reliabletravelnotary.com" style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.85rem", textDecoration: "none" }}>✉️ jgeli@reliabletravelnotary.com</a>
              </div>
              <div style={{ background: "var(--cream)", borderRadius: 4, padding: "24px", border: "1px solid rgba(201,168,76,0.2)" }}>
                ...
                {[
                  ...
                  "Have your document ready to review",
                ].map(tip => (
